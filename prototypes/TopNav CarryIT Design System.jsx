...
const TopNav = ({ activeView, onChange }) => {
  ...
  return (
    <nav style={navStyles.nav}>
      <div style={navStyles.topRow}>
        <div style={navStyles.left}>
          <a href="#" style={navStyles.brand}>
            <img src="../../assets/logo.png" alt="" style={navStyles.logo} aria-hidden="true" />
            <span style={navStyles.brandName}>CARRY IT</span>
          </a>
          <span style={navStyles.divider} aria-hidden="true">/</span>
          <button style={navStyles.dropdownTrigger}>
        ...
        <div style={navStyles.right}>
          <button style={navStyles.syncBtn}>
      ...
      <div style={navStyles.tabsRow} role="tablist">
        {tabs.map(t => {
